 ...
 */
@Controller
@RequestMapping(value = "/home/empUser")
public class UserPhoneController extends BaseController {
    ...
    public String index(EmpUser empUser, Model model) {
        ...
        return "home/user/userPhoneIndex";
    }

    @RequestMapping(value = "list")
    public String list(EmpUser empUser, Model model) {
        // 获取岗位列表
        System.out.println(">>>>>>> user phone list<<<<<<<<");
        Post post = new Post();
        model.addAttribute("postList", postService.findList(post));
        return "home/user/userPhoneList";
    }

    @RequestMapping(value = "orgtreeData")
    @ResponseBody
    public List<Map<String, Object>> orgTreeData(String excludeCode, String parentCode, Boolean isAll,
