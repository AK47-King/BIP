 ...
 */
package com.jeesite.modules.biz.tree.basicinfo.entity;
...
public class BasicInfoTree extends DataEntity<BasicInfoTree> {
	...
	public BasicInfoTree() {
		this(null);
	}

	public BasicInfoTree(String id){
		super(id);
	}
	...
	@Length(min=0, max=64, message="父节点长度不能超过 64 个字符")
